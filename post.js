    ...
    filter,
    {
      ...
      select:
        type === "pricesRange"
          ...
          : "id content.id content.name content.slug content.permalink content.status content.sku content.price content.regular_price content.sale_price content.total_sales content.stock_quantity content.stock_status content.related_ids content.categories content.images.id content.images.src content.images.name",
...
const formateToPosts = (user, products) => {
  let posts = [];
